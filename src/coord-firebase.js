  ...
  window.EVAL_CATALOG = [
    ...
    },
    {
      ...
      evaluaciones: [
        ...
        { id:'PF1–3', titulo:'Portafolio (3 evaluaciones)', tipo:'Portafolio Drive', puntos:'39/27/30', descripcion:'Construcción del portafolio (Ev. N°1), revisión intermedia de bitácora (Ev. N°2) y carga completa (Ev. N°3).' },
      ...
      ponderaciones: [
        ...
        { label:'Portafolio (3 evaluaciones promediadas)', peso:'10%' },
    ...
    },
    {
      ...
      evaluaciones: [
        ...
        { id:'PORT', titulo:'Portafolio y Bitácora (3 evaluaciones)', tipo:'Portafolio Drive', puntos:'—', descripcion:'Portafolio digital con bitácora de sesiones, evaluado en 3 momentos del semestre.' },
        ...
        { id:'SUP', titulo:'Supervisión en terreno + Portafolio', tipo:'Escala de apreciación', puntos:'—', descripcion:'Visitas del supervisor/a al terreno promediadas con las 3 evaluaciones del portafolio.' },
      ],
      ponderaciones: [
    ...
    },
    {
      ...
      evaluaciones: [
        ...
        { id:'PORT', titulo:'Portafolio y Bitácora (3 evaluaciones)', tipo:'Portafolio Drive', puntos:'36/27/30', descripcion:'Tres evaluaciones: Ev. N°1 construcción+bitácora (36 pts), N°2 bitácora (27 pts), N°3 carga completa (30 pts).' },
