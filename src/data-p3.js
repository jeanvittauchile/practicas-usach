...
(function () {
  ...
  // + evaluación semestral del/la supervisor/a.
  ...
  function buildPracticaPI() {
    ...
    return {
      ...
      NOTAS_COLUMNS: [
        ...
        { key: 'SEMESTRAL', label: 'Eval. semestral', sub: 'incl. en 25%', kind: 'semestral' },
      ...
      RESOLVERS: {
        ...
        SEMESTRAL: (estId, state) => {
          const r = window.USACH_CALC.calcInstrumento(state.semestral && state.semestral[estId], SEMESTRAL_DIMENSIONES, NIVELES_APREC, ESCALA_SEMESTRAL);
          return r ? { nota: r.nota, parcial: r.parcial } : { nota: null, parcial: true };
        },
        AUTO: (estId, state) => {
